 ...
 * @return void
 */
function journeytourismpro_register_block_patterns()
{
    $block_pattern_categories = array(
        'journey-turism' => array('label' => esc_html__('journey-turism', 'journey-turism')),
        'pages'  => array('label' => esc_html__('Pages', 'journey-turism')),
    );
     ...
     * }
     */
    $block_pattern_categories = apply_filters('journeytourismpro_block_pattern_categories', $block_pattern_categories);
        ...
        if (is_file($file_path) && pathinfo($file_path, PATHINFO_EXTENSION) == 'php') {
            ...
            if ($file !== 'pricing-table-2.php') {
                ...
                if (!empty($pattern_content)) {
                    ...
                    $pattern_name = 'journey-turism-pattern-' . sanitize_title($pattern_title); // Generate a unique name for the pattern
...
add_action('init', 'journeytourismpro_register_block_patterns', 9);
