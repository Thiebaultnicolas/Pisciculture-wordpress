 ...
 */
 ...
 function journeytourismpro_wpdocs_block_pattern_category() {
	register_block_pattern_category( 'free-patterns', array(
		'label' => __( 'Free Paterns', 'journey-turism' )
	) );
}
 ...
 function journeytourismpro_custom_register_block_patterns()
{
    ...
    register_block_pattern(
        ...
        array(
            'title'       => __( 'Countries Stories', 'journey-turism' ), // Title displayed in the block editor
    ...
    register_block_pattern(
        ...
        array(
            'title'       => __( 'Main home', 'journey-turism' ), // Title displayed in the block editor
    ...
    register_block_pattern(
        'Contact Us', // Unique name for your pattern
        array(
            'title'       => __( 'Contact Us', 'journey-turism' ), // Title displayed in the block editor
            'description' => 'Contact section', // Description of your pattern

            'content'     => '<!-- wp:group {"style":{"dimensions":{"minHeight":"70vh"},"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"},"blockGap":"var:preset|spacing|70","margin":{"top":"var:preset|spacing|40","bottom":"var:preset|spacing|40"}},"background":{"backgroundImage":{"url":"' . esc_url(get_theme_file_uri('/assets/images/line-black-1-1.png')) . '","id":800,"source":"file","title":"line-black-1-1"},"backgroundRepeat":"no-repeat","backgroundSize":"contain"}},"layout":{"type":"constrained"},"fontSize":"smallbig"} -->
            <div class="wp-block-group has-smallbig-font-size" style="min-height:70vh;margin-top:var(--wp--preset--spacing--40);margin-bottom:var(--wp--preset--spacing--40);padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|40"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"center"}} -->
            <div class="wp-block-group"><!-- wp:paragraph {"align":"center","style":{"elements":{"link":{"color":{"text":"var:preset|color|custom-color-1"}}}},"textColor":"custom-color-1","className":"fade-up","fontSize":"medium","fontFamily":"tenor-sans"} -->
            <p class="has-text-align-center fade-up has-custom-color-1-color has-text-color has-link-color has-tenor-sans-font-family has-medium-font-size">Location</p>
            <!-- /wp:paragraph -->
            
            <!-- wp:paragraph {"align":"center","style":{"elements":{"link":{"color":{"text":"var:preset|color|custom-color-1"}}}},"textColor":"custom-color-1","className":"fade-up","fontSize":"smallbig","fontFamily":"tenor-sans"} -->
            <p class="has-text-align-center fade-up has-custom-color-1-color has-text-color has-link-color has-tenor-sans-font-family has-smallbig-font-size">2020 Lomita Blvd,&nbsp;Torrance, CA 90101<br>United States</p>
            <!-- /wp:paragraph --></div>
            <!-- /wp:group -->
            
            <!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|40"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"center"}} -->
            <div class="wp-block-group"><!-- wp:paragraph {"align":"center","style":{"elements":{"link":{"color":{"text":"var:preset|color|custom-color-1"}}}},"textColor":"custom-color-1","className":"fade-up","fontSize":"medium","fontFamily":"tenor-sans"} -->
            <p class="has-text-align-center fade-up has-custom-color-1-color has-text-color has-link-color has-tenor-sans-font-family has-medium-font-size">Email</p>
            <!-- /wp:paragraph -->
            
            <!-- wp:paragraph {"align":"center","style":{"elements":{"link":{"color":{"text":"var:preset|color|custom-color-1"}}}},"textColor":"custom-color-1","className":"fade-up","fontSize":"smallbig","fontFamily":"tenor-sans"} -->
            <p class="has-text-align-center fade-up has-custom-color-1-color has-text-color has-link-color has-tenor-sans-font-family has-smallbig-font-size">example@test.com</p>
            <!-- /wp:paragraph --></div>
            <!-- /wp:group -->
            
            <!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|40"}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"center"}} -->
            <div class="wp-block-group"><!-- wp:paragraph {"align":"center","style":{"elements":{"link":{"color":{"text":"var:preset|color|custom-color-1"}}}},"textColor":"custom-color-1","className":"fade-up","fontSize":"medium","fontFamily":"tenor-sans"} -->
            <p class="has-text-align-center fade-up has-custom-color-1-color has-text-color has-link-color has-tenor-sans-font-family has-medium-font-size">Telephone</p>
            <!-- /wp:paragraph -->
            
            <!-- wp:paragraph {"align":"center","style":{"elements":{"link":{"color":{"text":"var:preset|color|custom-color-1"}}}},"textColor":"custom-color-1","className":"fade-up","fontSize":"smallbig","fontFamily":"tenor-sans"} -->
            <p class="has-text-align-center fade-up has-custom-color-1-color has-text-color has-link-color has-tenor-sans-font-family has-smallbig-font-size">+12 (34) 5678-9012</p>
            <!-- /wp:paragraph --></div>
            <!-- /wp:group -->
            
            <!-- wp:social-links {"iconColor":"custom-color-2","iconColorValue":"#68b684","iconBackgroundColor":"white","iconBackgroundColorValue":"#ffffff","className":"is-style-default fade-up","layout":{"type":"flex","justifyContent":"center"}} -->
            <ul class="wp-block-social-links has-icon-color has-icon-background-color is-style-default fade-up"><!-- wp:social-link {"url":"#","service":"facebook"} /-->
            ...
            <!-- /wp:group -->', // HTML content of your pattern
            'categories'  => array('free-patterns'), // Category under which your pattern should appear
            'keywords'    => array('custom', 'pattern', 'my', 'contact'), // Keywords to help users find your pattern
        )
    );

    register_block_pattern(
        'Our best adventurers', // Unique name for your pattern
        array(
            'title'       => __( 'Our best adventurers', 'journey-turism' ), // Title displayed in the block editor
            'description' => 'Section showing company members', // Description of your pattern

            'content'     => '<!-- wp:group {"align":"full","style":{"spacing":{"blockGap":"0","padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"},"margin":{"top":"0","bottom":"0"}}},"layout":{"type":"default"}} -->
            <div class="wp-block-group alignfull" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80)"><!-- wp:paragraph {"align":"center","style":{"elements":{"link":{"color":{"text":"var:preset|color|custom-color-2"}}},"typography":{"fontStyle":"normal","fontWeight":"500","textTransform":"uppercase"},"spacing":{"margin":{"top":"var:preset|spacing|40"}}},"textColor":"custom-color-2","className":"fade-up","fontSize":"smallbig","fontFamily":"roboto"} -->
            <p class="has-text-align-center fade-up has-custom-color-2-color has-text-color has-link-color has-roboto-font-family has-smallbig-font-size" style="margin-top:var(--wp--preset--spacing--40);font-style:normal;font-weight:500;text-transform:uppercase">meet the team</p>
            <!-- /wp:paragraph -->
            ...
            <p class="has-text-align-center big-titles fade-up has-custom-color-1-color has-text-color has-link-color has-tenor-sans-font-family has-x-large-font-size" style="margin-bottom:var(--wp--preset--spacing--60)">Our best adventurers</p>
            <!-- /wp:paragraph -->
            
            <!-- wp:group {"style":{"spacing":{"margin":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60"},"padding":{"top":"var:preset|spacing|60","bottom":"var:preset|spacing|60"},"blockGap":"var:preset|spacing|80"}},"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"center"}} -->
            <div class="wp-block-group" style="margin-top:var(--wp--preset--spacing--60);margin-bottom:var(--wp--preset--spacing--60);padding-top:var(--wp--preset--spacing--60);padding-bottom:var(--wp--preset--spacing--60)"><!-- wp:group {"style":{"border":{"radius":"5px","width":"1px"},"spacing":{"blockGap":"0","margin":{"bottom":"0"},"padding":{"right":"0","left":"0"}}},"borderColor":"custom-color-2","className":"fade-left","layout":{"type":"flex","orientation":"vertical","justifyContent":"center","flexWrap":"wrap"}} -->
            <div class="wp-block-group fade-left has-border-color has-custom-color-2-border-color" style="border-width:1px;border-radius:5px;margin-bottom:0;padding-right:0;padding-left:0"><!-- wp:image {"id":240,"width":"350px","height":"200px","scale":"cover","sizeSlug":"large","linkDestination":"none","style":{"border":{"radius":{"topLeft":"3px","topRight":"3px"}}}} -->
            <figure class="wp-block-image size-large is-resized has-custom-border"><img src="' . esc_url(get_theme_file_uri('/assets/images/men1-768x1024.jpeg')) . '" alt="" class="wp-image-240" style="border-top-left-radius:3px;border-top-right-radius:3px;object-fit:cover;width:350px;height:200px"/></figure>
            <!-- /wp:image -->
            
            <!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"}}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"center"}} -->
            <div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)"><!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|custom-color-1"}}},"spacing":{"margin":{"top":"var:preset|spacing|40"}}},"textColor":"custom-color-1","fontSize":"medium","fontFamily":"tenor-sans"} -->
            <p class="has-custom-color-1-color has-text-color has-link-color has-tenor-sans-font-family has-medium-font-size" style="margin-top:var(--wp--preset--spacing--40)">Mike Lewis</p>
            <!-- /wp:paragraph -->
            
            <!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|custom-color-2"}}},"typography":{"fontStyle":"normal","fontWeight":"600","letterSpacing":"0.18px"}},"textColor":"custom-color-2","fontSize":"smallbig","fontFamily":"roboto"} -->
            <p class="has-custom-color-2-color has-text-color has-link-color has-roboto-font-family has-smallbig-font-size" style="font-style:normal;font-weight:600;letter-spacing:0.18px">TOUR GUIDE</p>
            <!-- /wp:paragraph -->
            
            <!-- wp:social-links {"iconColor":"custom-color-3","iconColorValue":"#fffdfa","iconBackgroundColor":"custom-color-1","iconBackgroundColorValue":"#000e1b","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|50","top":"var:preset|spacing|50"}}},"className":"is-style-pill-shape"} -->
            <ul class="wp-block-social-links has-icon-color has-icon-background-color is-style-pill-shape" style="margin-top:var(--wp--preset--spacing--50);margin-bottom:var(--wp--preset--spacing--50)"><!-- wp:social-link {"url":"#","service":"facebook"} /-->
            ...
            <!-- wp:group {"style":{"border":{"radius":"5px","width":"1px"},"spacing":{"blockGap":"0","margin":{"bottom":"0"},"padding":{"right":"0","left":"0"}}},"borderColor":"custom-color-2","className":"fade-up","layout":{"type":"flex","orientation":"vertical","justifyContent":"center","flexWrap":"wrap"}} -->
            <div class="wp-block-group fade-up has-border-color has-custom-color-2-border-color" style="border-width:1px;border-radius:5px;margin-bottom:0;padding-right:0;padding-left:0"><!-- wp:image {"id":241,"width":"350px","height":"200px","scale":"cover","sizeSlug":"large","linkDestination":"none","style":{"border":{"radius":{"topRight":"3px","topLeft":"3px"}}}} -->
            <figure class="wp-block-image size-large is-resized has-custom-border"><img src="' . esc_url(get_theme_file_uri('/assets/images/men2-1024x683.jpg')) . '" alt="" class="wp-image-241" style="border-top-left-radius:3px;border-top-right-radius:3px;object-fit:cover;width:350px;height:200px"/></figure>
            <!-- /wp:image -->
            
            <!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"}}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"center"}} -->
            <div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)"><!-- wp:paragraph {"align":"center","style":{"elements":{"link":{"color":{"text":"var:preset|color|custom-color-1"}}},"spacing":{"margin":{"top":"var:preset|spacing|40"},"padding":{"right":"0","left":"0"}}},"textColor":"custom-color-1","fontSize":"medium","fontFamily":"tenor-sans"} -->
            <p class="has-text-align-center has-custom-color-1-color has-text-color has-link-color has-tenor-sans-font-family has-medium-font-size" style="margin-top:var(--wp--preset--spacing--40);padding-right:0;padding-left:0">Willian Francis</p>
            <!-- /wp:paragraph -->
            
            <!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|custom-color-2"}}},"typography":{"fontStyle":"normal","fontWeight":"600","letterSpacing":"0.18px"}},"textColor":"custom-color-2","fontSize":"smallbig","fontFamily":"roboto"} -->
            <p class="has-custom-color-2-color has-text-color has-link-color has-roboto-font-family has-smallbig-font-size" style="font-style:normal;font-weight:600;letter-spacing:0.18px">CEO</p>
            <!-- /wp:paragraph -->
            ...
            <!-- wp:group {"style":{"border":{"radius":"5px","width":"1px"},"spacing":{"blockGap":"0","margin":{"bottom":"0"},"padding":{"right":"0","left":"0"}}},"borderColor":"custom-color-2","className":"fade-right","layout":{"type":"flex","orientation":"vertical","justifyContent":"center","flexWrap":"wrap"}} -->
            <div class="wp-block-group fade-right has-border-color has-custom-color-2-border-color" style="border-width:1px;border-radius:5px;margin-bottom:0;padding-right:0;padding-left:0"><!-- wp:image {"id":242,"width":"350px","height":"200px","scale":"cover","sizeSlug":"large","linkDestination":"none","style":{"border":{"radius":{"topLeft":"3px","topRight":"3px"}}}} -->
            <figure class="wp-block-image size-large is-resized has-custom-border"><img src="' . esc_url(get_theme_file_uri('/assets/images/woman1-1024x461.jpg')) . '" alt="" class="wp-image-242" style="border-top-left-radius:3px;border-top-right-radius:3px;object-fit:cover;width:350px;height:200px"/></figure>
            <!-- /wp:image -->
            
            <!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"}}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"center"}} -->
            <div class="wp-block-group" style="padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)"><!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|custom-color-1"}}},"spacing":{"margin":{"top":"var:preset|spacing|40"}}},"textColor":"custom-color-1","fontSize":"medium","fontFamily":"tenor-sans"} -->
            <p class="has-custom-color-1-color has-text-color has-link-color has-tenor-sans-font-family has-medium-font-size" style="margin-top:var(--wp--preset--spacing--40)">Jane Phill</p>
            <!-- /wp:paragraph -->
            
            <!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|custom-color-2"}}},"typography":{"fontStyle":"normal","fontWeight":"600","letterSpacing":"0.18px"}},"textColor":"custom-color-2","fontSize":"smallbig","fontFamily":"roboto"} -->
            <p class="has-custom-color-2-color has-text-color has-link-color has-roboto-font-family has-smallbig-font-size" style="font-style:normal;font-weight:600;letter-spacing:0.18px">TRANSLATOR</p>
            <!-- /wp:paragraph -->
            ...
            <!-- /wp:group -->', // HTML content of your pattern
            'categories'  => array('free-patterns'), // Category under which your pattern should appear
            'keywords'    => array('custom', 'pattern', 'my', 'menbers', 'team', 'our best adventurers', 'adventurers'), // Keywords to help users find your pattern
        )
    );
    ...
    register_block_pattern(
        ...
        array(
            'title'       => __( 'How we started', 'journey-turism' ), // Title displayed in the block editor
