<?php
/**
 * Title: wp-custom-template-index-alternative
 * Slug: journey-turism/wp-custom-template-index-alternative
 * Categories: hidden
 * Inserter: no
 */
?>
<!-- wp:template-part {"slug":"header-alternative","area":"uncategorized"} /-->
...
<!-- wp:group {"style":{"spacing":{"blockGap":"0","padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80","left":"1rem","right":"1rem"},"margin":{"top":"0","bottom":"0"}},"background":{"backgroundSize":"contain","backgroundPosition":"50% 50%","backgroundRepeat":"no-repeat","backgroundImage":{"url":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/Desktop-3-1.png","id":289,"source":"file","title":"bg-home2"}}},"layout":{"type":"default"}} -->
...
<div class="wp-block-group box-home-services has-background" style="background-color:#ffffff00;padding-right:0;padding-left:0"><!-- wp:image {"width":"120px","aspectRatio":"1","scale":"contain","sizeSlug":"full","linkDestination":"none","className":"imgs-home-services"} -->
<figure class="wp-block-image size-full is-resized imgs-home-services"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/passport-2.png" alt="" style="aspect-ratio:1;object-fit:contain;width:120px"/></figure>
<!-- /wp:image -->
...
<figure class="wp-block-image size-large"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/services2-1024x683.jpg" alt="" style="aspect-ratio:1;object-fit:cover"/></figure>
<!-- /wp:image -->
...
<div class="wp-block-group alignwide fade-right" style="border-top-style:none;border-top-width:0px;border-right-style:none;border-right-width:0px;border-bottom-color:var(--wp--preset--color--custom-color-2);border-bottom-style:none;border-bottom-width:0px;border-left-style:none;border-left-width:0px;padding-right:0;padding-left:0"><!-- wp:image {"aspectRatio":"1","scale":"cover","sizeSlug":"large","linkDestination":"none","style":{"color":{"duotone":"unset"},"layout":{"selfStretch":"fixed","flexSize":"20rem"}}} -->
<figure class="wp-block-image size-large"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/beach-landscape-sea-coast-water-nature-677311-pxhere.com_-1024x533.jpg" alt="" style="aspect-ratio:1;object-fit:cover"/></figure>
<!-- /wp:image -->
...
<div class="wp-block-group fade-up has-background" style="background-color:#ffffff00;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0"><!-- wp:post-featured-image {"isLink":true,"aspectRatio":"16/9","height":"19em","className":"imgs-home-blog"} /-->
...
<div class="wp-block-group"><!-- wp:post-date {"isLink":true,"style":{"elements":{"link":{"color":{"text":"var:preset|color|custom-color-1"}}}},"textColor":"custom-color-1","fontSize":"medium","fontFamily":"tenor-sans"} /-->
...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80","left":"0","right":"0"},"blockGap":"0"},"background":{"backgroundImage":{"url":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/Frame-1.png","id":278,"source":"file","title":"Frame 1"},"backgroundRepeat":"no-repeat","backgroundSize":"contain"}},"layout":{"type":"constrained"}} -->
